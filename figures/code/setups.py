...
custom_cmap = LinearSegmentedColormap.from_list("custom_tealgreen", SIM_BAR_COLORS, N=256)

################################# below are the same as the setups.py from result_analysis directory
# 'protein': "#AF8CBC",
PALETTE_OMICS = {
    'CNV'   : "#ffd8b1",
    'DNAm'  : "#95D378",
...
MODELS_OUTPUT_ONE_MINUS_P_VALUES = ['ttest', 'mannwhitneyu'] # scores are "1 - p values"
...
# NOTE ORDERING
categories = { # also the method you want to include in the plot
    # dl
