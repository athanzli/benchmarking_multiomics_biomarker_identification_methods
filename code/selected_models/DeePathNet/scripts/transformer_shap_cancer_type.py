...
config_file = "/home/athan.li/eval_bk/code/selected_models/DeePathNet/configs/deepathnet_forbk_multiclass.json" # NOTE
mode = "grad" # NOTE
...
def run_shap(merged_df_train, merged_df_test):
    ...
    shap_values = explainer.shap_values( # [N,F,M,O]
