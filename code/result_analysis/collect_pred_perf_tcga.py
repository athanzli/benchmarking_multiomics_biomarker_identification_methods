...
for task in TASKS:
    ...
    if 'survival' in task:
        ...
        # RES_PATH = f"/home/athan.li/eval_bk/result_after0726_woprotein/{task}" + '_binary/'
    else:
        RES_PATH = f"/home/athan.li/eval_bk/result/{task}/" 
        # RES_PATH = f"/home/athan.li/eval_bk/result_after0726_woprotein/{task}/" 
...
#%%
res_all.to_csv(f"../../result/pred_res_TCGA.csv")
